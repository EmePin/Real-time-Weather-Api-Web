 ...
 * @param {number} timezone Timezone shift from UTC in seconds
 * @returns {string} Time String. formate:"10:00 AM"
 */
 ...
 * @param {number} timeUnix Unix date in seconds
 * @param {number} timezone Timezone shift from UTC in seconds
 * @returns {string} Time String. formate:"10 AM"
 */
...
export const aqiText = {
    ...
    2: {
        level: "Fair",
        message: "Air quality is acceptable. However, for some pollutants there may be a risk for some people, particularly those who are unusually sensitive to air pollution."
    },
    3: {
        level: "Moderate",
